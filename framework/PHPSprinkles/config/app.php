...
return [
     ...
     *
     * Local development defaults are provided by PHPSprinklesCors when `debug=true`.
     * Production-like environments emit no CORS headers unless allowed origins are
     * explicitly configured here or in app_local.php.
     */
    'Cors' => [
        // 'enabled' => true,
